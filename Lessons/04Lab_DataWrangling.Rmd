...
NTL.phys.data %>%
  filter(lakename == "Tuesday Lake", year4 == 1990:1999)
...
NTL.phys.data$sampledate <- format(NTL.phys.data$sampledate, "%m")

NTL.phys.data %>%
  filter(lakename == "Tuesday Lake", sampledate == "07") %>%
...
NTL.phys.data %>%
  filter(lakename == "Tuesday Lake", sampledate == "07", depth==0.00) %>%
  filter(year4 == 1990:1999) %>%
